                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        child: TextField(
                                          ...
                                          decoration: InputDecoration(
                                            hintText: '6599fa8364fb8a601019c750',
                                            fillColor: Colors.white,
                                            filled: true,
                                            contentPadding: EdgeInsets.symmetric(
                                                vertical: 1.0, horizontal: 10.0),
                            ...
                            Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                items: [
                                  DropdownMenuItem(
                                      child: Text(selectedStatus), value: selectedStatus),
                                ],
                                onChanged: (value) {
                                  // Handle value change
                                  setState(() {
                            ...
                            Wrap(
                              ...
                              children: [
                                registeredCourses.length == 0
                                    ...
                                    : Text(""),
                                for (String course in registeredCourses)
                                  Container(
                                    child: TextButton(
                                      onPressed: () {
                              ...
                              onPressed: () async {
                                try {
                                  await courseProvider.addCourse(Course(
                                    id: "",
                                    registrationStatus: selectedStatus,
